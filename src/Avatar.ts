...
export default class Avatar extends JiraType {
  constructor(
  ...
  delete = async (destination=`/rest/atlassian-connect/1/universal_avatar/type/${this.type}/owner/${this.ownerId}/${this.body.id}`) => {
