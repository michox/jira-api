...
> {
  ...
  async read() {
    let response = await JiraApi(`/rest/atlassian-connect/1/addons/${addonKey}/properties/${this.propertyKey}`);
  ...
  async update(property = this._property) {
    ...
    this._property = property;
    await JiraApi(`/rest/atlassian-connect/1/addons/${addonKey}/properties/${this.propertyKey}`, property, "PUT");
    return this;
  }
  ...
  async delete() {
    this._property = {} as P;
    return Promise.all([
      JiraApi(`/rest/atlassian-connect/1/addons/${addonKey}/properties/${this.propertyKey}.backup`, {}, "DELETE"),
      JiraApi(`/rest/atlassian-connect/1/addons/${addonKey}/properties/${this.propertyKey}`, {}, "DELETE"),
    ]);
  }
